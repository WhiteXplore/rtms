<template>
  <div
    class="bg-white py-1 rounded-t-lg flex justify-between items-center p-6 shadow"
  >
    <!-- Left Section: Title -->
    <div class="text-[#147452] font-semibold text-[12px] tracking-wider">
  ...
  <!-- Profile Dropdown -->
  <div class="absolute top-[75px] right-6 z-50">
